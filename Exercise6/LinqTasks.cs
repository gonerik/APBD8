...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(s => s.Job.Equals("Backend programmer"));;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(s => s.Job.Equals("Frontend programmer") && s.Salary>1000)
                .OrderByDescending(s => s.Ename);
            return result;
        }
        ...
        {
            int result = Emps.Max(s => s.Salary);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(s => s.Salary== Emps.Max(s => s.Salary));
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Select(s => new
            {
                Nazwisko = s.Ename,
                Praca = s.Job
            });
        ...
        {
            IEnumerable<object> result = Emps.GroupBy(s => s.Job).Select(g => new
            {
                Praca = g.Key,
        ...
        {
            bool result = Emps.Any(s => s.Job.Equals("Backend programmer"));
            return result;
        }
        ...
        {
            Emp result = Emps.Where(emp => emp.Job.Equals("Frontend programmer")).OrderByDescending(s => s.HireDate).FirstOrDefault();
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new
            {
                emp.Ename,
                dept.Dname
            } ).GroupBy(g => g.Dname).Select(q => new
            {
                name = q.Key,
                numOfEmployees = q.Count()
            });
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        public static IEnumerable<Emp> WithDirectSubordinates(this IEnumerable<Emp> emps)
        {
            ...
            result = result.OrderBy(e => e.Ename)
